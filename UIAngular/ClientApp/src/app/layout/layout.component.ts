...
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        // Set the app version
        this._renderer2.setAttribute(this._document.querySelector('[ng-version]'), 'project-version', '0.0.0');
    }
    ...
    private _updateTheme(): void
    {
        ...
        this._document.body.classList.forEach((className: string) => {
            ...
            {
                this._document.body.classList.remove(className, className.split('DOWN')[1]);
            }
        });
